...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('do_post', 'pub_date')

        # Adding field 'Post.last_sync'
        db.add_column('do_post', 'last_sync',
    ...
    def backwards(self, orm):
        ...
        db.add_column('do_post', 'pub_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Deleting field 'Post.last_sync'
        db.delete_column('do_post', 'last_sync')
