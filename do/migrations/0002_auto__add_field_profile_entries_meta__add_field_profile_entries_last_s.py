...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.entries_meta'
        db.add_column('do_profile', 'entries_meta',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.entries_last_sync'
        db.add_column('do_profile', 'entries_last_sync',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.entries_meta'
        db.delete_column('do_profile', 'entries_meta')

        # Deleting field 'Profile.entries_last_sync'
        db.delete_column('do_profile', 'entries_last_sync')
