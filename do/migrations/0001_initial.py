...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('do_profile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('journal_path', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True)),
            ('journal_share_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True)),
            ('photos_path', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True)),
            ('photos_share_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True)),
            ('entries_path', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True)),
            ('entries_share_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True)),
            ('pub_tag', self.gf('django.db.models.fields.CharField')(default='public', max_length=200)),
        ))
        db.send_create_signal('do', ['Profile'])

        # Adding model 'Post'
        db.create_table('do_post', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('entry_path', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True)),
            ('entry_share_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True)),
            ('content', self.gf('django.db.models.fields.TextField')(default=None, null=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='', max_length=64, null=True, blank=True)),
            ('pub_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('all_tags', self.gf('django.db.models.fields.TextField')(default=None, null=True)),
        ))
        db.send_create_signal('do', ['Post'])


    def backwards(self, orm):
        # Deleting model 'Profile'
        db.delete_table('do_profile')

        # Deleting model 'Post'
        db.delete_table('do_post')
