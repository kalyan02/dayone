...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('do_post', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Post.is_anonymous'
        db.add_column('do_post', 'is_anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('do_post', 'is_public')

        # Deleting field 'Post.is_anonymous'
        db.delete_column('do_post', 'is_anonymous')
