...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.anon_tag'
        db.add_column('do_profile', 'anon_tag',
                      self.gf('django.db.models.fields.CharField')(default='anonymous', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.anon_tag'
        db.delete_column('do_profile', 'anon_tag')
    ...
    models = {
        ...
        'do.profile': {
            ...
            'anon_tag': ('django.db.models.fields.CharField', [], {'default': "'anonymous'", 'max_length': '200'}),
